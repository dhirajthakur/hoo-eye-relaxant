namespace Hoo.Relaxant {
    partial class SettingForm {
        ...
        private void InitializeComponent() {
			...
			this.adminPassowordText = new System.Windows.Forms.TextBox();
			this.childPasswordLabel = new System.Windows.Forms.Label();
			...
			// generalTab
			// 
			this.generalTab.Controls.Add(this.adminPassowordText);
			this.generalTab.Controls.Add(this.childPasswordLabel);
			...
			// adminPassowordText
			// 
			resources.ApplyResources(this.adminPassowordText, "adminPassowordText");
			this.adminPassowordText.Name = "adminPassowordText";
			this.adminPassowordText.UseSystemPasswordChar = true;
			// 
			// childPasswordLabel
			// 
			resources.ApplyResources(this.childPasswordLabel, "childPasswordLabel");
			this.childPasswordLabel.Name = "childPasswordLabel";
			// 
			// languageCombo
			// 
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("languageCombo.Properties.Buttons"))))});
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("breakCompletingSystemWarningCombo.Properties.Buttons"))))});
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("shutdownHotkeyCombo.Properties.Buttons"))))});
		...
		private System.Windows.Forms.TextBox adminPassowordText;
		private System.Windows.Forms.Label childPasswordLabel;
    }
}